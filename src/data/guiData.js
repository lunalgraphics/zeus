...
export const guiSections = {
    ...
    Branches: [
        { label: "Max Branches", key: "numBranches", type: "number", value: 5, attr: { step: 1 }, tooltip: "Maximum number of branches per strand" },
        { label: "Branch Probability", key: "branchProbability", type: "number", value: 60, attr: { step: 1, min: 0, max: 100 }, tooltip: "Chance (%) that each branch actually spawns" },
        { label: "Max Length", key: "branchLenMax", type: "number", value: 300, attr: { step: 1, min: 0 }, tooltip: "Length of the longest branch in pixels" },
        { label: "Min Length", key: "branchLenMin", type: "number", value: 80, attr: { step: 1, min: 0 }, tooltip: "Length of the shortest branch in pixels" },
        ...
        { label: "Seed", key: "branchSeed", type: "number", value: 1, attr: { step: 1 }, tooltip: "Random seed for branch probability and length variance" },
    ],
    Core: [
